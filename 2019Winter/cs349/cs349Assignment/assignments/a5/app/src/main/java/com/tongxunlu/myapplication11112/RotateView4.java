...
public class RotateView4 extends View {
    Bitmap bitmap;
    Matrix matrix ;
    int width , height ;
    int degrees ;
    ...
    public RotateView4(Context context) {
        super(context);
    ...
    public RotateView4(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Drawable drawable = this.getResources().getDrawable(
                R.mipmap.foot_right);
        BitmapDrawable drawable2 = (BitmapDrawable) drawable ;
    ...
    public RotateView4(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
