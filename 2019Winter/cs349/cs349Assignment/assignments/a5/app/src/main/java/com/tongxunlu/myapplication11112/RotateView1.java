...
public class RotateView1 extends View {
    ...
    public RotateView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Drawable drawable = this.getResources().getDrawable(
                R.mipmap.lowerleg_right);
        BitmapDrawable drawable2 = (BitmapDrawable) drawable ;
    ...
    public RotateView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
